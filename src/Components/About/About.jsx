...
const About = () => {
    return (
        <div>
            <section id="About">
                <div className='about container-fluid pt-2'>
                    <div>
                    ...
                    <div className="row">
                        ...
                        <div className="col pb-5">
                            <div>
                                ...
                                <p className="about-para ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis quae voluptas voluptatibus labore sequi, ipsam molestias inventore animi tempora maxime iure,</p>
                            </div>
                        </div>
                    </div>
